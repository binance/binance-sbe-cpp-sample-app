...
#ifndef _SPOT_SBE_GROUPSIZEENCODING_CXX_H_
#define _SPOT_SBE_GROUPSIZEENCODING_CXX_H_
...
public:
    ...
    {
        if (SBE_BOUNDS_CHECK_EXPECT(((m_offset + 6) > m_bufferLength), false))
        {
    ...
    static SBE_CONSTEXPR std::uint32_t numInGroupNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_UINT32;
    }

    static SBE_CONSTEXPR std::uint32_t numInGroupMinValue() SBE_NOEXCEPT
    {
        return UINT32_C(0x0);
    }

    static SBE_CONSTEXPR std::uint32_t numInGroupMaxValue() SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD std::uint32_t numInGroup() const SBE_NOEXCEPT
    {
        std::uint32_t val;
    ...
    GroupSizeEncoding &numInGroup(const std::uint32_t value) SBE_NOEXCEPT
    {
