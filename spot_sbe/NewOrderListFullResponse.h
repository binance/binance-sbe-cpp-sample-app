...
#ifndef _SPOT_SBE_NEWORDERLISTFULLRESPONSE_CXX_H_
#define _SPOT_SBE_NEWORDERLISTFULLRESPONSE_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(311);
    ...
    NewOrderListFullResponse() = default;
    ...
    NewOrderListFullResponse(char *buffer, const std::uint64_t bufferLength) :
        NewOrderListFullResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    NewOrderListFullResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        NewOrderListFullResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return static_cast<std::uint16_t>(311);
    }
    ...
    NewOrderListFullResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    NewOrderListFullResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    NewOrderListFullResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    NewOrderListFullResponse &sbeRewind()
    {
    ...
    {
        NewOrderListFullResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    NewOrderListFullResponse &orderListId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    NewOrderListFullResponse &contingencyType(const ContingencyType::Value value) SBE_NOEXCEPT
    {
    ...
    NewOrderListFullResponse &listStatusType(const ListStatusType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    NewOrderListFullResponse &listOrderStatus(const ListOrderStatus::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    NewOrderListFullResponse &transactionTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderListFullResponse &priceExponent(const std::int8_t value) SBE_NOEXCEPT
    {
    ...
    NewOrderListFullResponse &qtyExponent(const std::int8_t value) SBE_NOEXCEPT
    {
        std::int8_t val = (value);
...
public:
    ...
    #pragma GCC diagnostic pop
            ...
            m_bufferLength = bufferLength;
            GroupSize16Encoding dimensions(buffer, *pos, bufferLength, actingVersion);
            dimensions.blockLength(static_cast<std::uint16_t>(152));
            dimensions.numInGroup(static_cast<std::uint16_t>(count));
            m_index = 0;
            m_count = count;
            m_blockLength = 152;
        ...
        {
            std::int64_t val;
            std::memcpy(&val, m_buffer + m_offset + 132, sizeof(std::int64_t));
            return SBE_LITTLE_ENDIAN_ENCODE_64(val);
        }
        ...
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
            std::memcpy(m_buffer + m_offset + 132, &val, sizeof(std::int64_t));
            return *this;
        }
        ...
        SBE_NODISCARD std::uint8_t pegOffsetTypeRaw() const SBE_NOEXCEPT
        {
            ...
            std::uint8_t val;
            std::memcpy(&val, m_buffer + m_offset + 141, sizeof(std::uint8_t));
            return (val);
        }
        ...
        {
            std::uint8_t val = (value);
            std::memcpy(m_buffer + m_offset + 141, &val, sizeof(std::uint8_t));
            return *this;
        }
        ...
        SBE_NODISCARD std::int64_t peggedPrice() const SBE_NOEXCEPT
        {
            ...
            std::int64_t val;
            std::memcpy(&val, m_buffer + m_offset + 143, sizeof(std::int64_t));
            return SBE_LITTLE_ENDIAN_ENCODE_64(val);
        }
        ...
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
            std::memcpy(m_buffer + m_offset + 143, &val, sizeof(std::int64_t));
            return *this;
        }
        ...
        OrderReports &expiryReason(const ExpiryReason::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
...
public:
    ...
    NewOrderListFullResponse &putListClientOrderId(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    NewOrderListFullResponse &putListClientOrderId(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    NewOrderListFullResponse &putListClientOrderId(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    NewOrderListFullResponse &putSymbol(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    NewOrderListFullResponse &putSymbol(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    NewOrderListFullResponse &putSymbol(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const NewOrderListFullResponse &_writer)
{
    NewOrderListFullResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "NewOrderListFullResponse", )";
...
#pragma GCC diagnostic ignored "-Wtype-limits"
    ...
    for (const auto &e: orderReportsItemLengths)
    {
        ...
        #else
        length += OrderReports::computeLength(std::get<0>(e), std::get<1>(e), std::get<2>(e), std::get<3>(e));
        #endif
    }
