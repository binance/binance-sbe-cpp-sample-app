...
#ifndef _SPOT_SBE_EXCHANGEMAXNUMICEBERGORDERSFILTER_CXX_H_
#define _SPOT_SBE_EXCHANGEMAXNUMICEBERGORDERSFILTER_CXX_H_
...
public:
    ...
    ExchangeMaxNumIcebergOrdersFilter() = default;
    ...
    ExchangeMaxNumIcebergOrdersFilter(char *buffer, const std::uint64_t bufferLength) :
        ExchangeMaxNumIcebergOrdersFilter(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExchangeMaxNumIcebergOrdersFilter(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExchangeMaxNumIcebergOrdersFilter(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ExchangeMaxNumIcebergOrdersFilter &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ExchangeMaxNumIcebergOrdersFilter &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    ExchangeMaxNumIcebergOrdersFilter &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    ExchangeMaxNumIcebergOrdersFilter &sbeRewind()
    {
    ...
    {
        ExchangeMaxNumIcebergOrdersFilter skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    {
        return FilterType::Value::ExchangeMaxNumIcebergOrders;
    }
    ...
    {
        return static_cast<std::uint8_t>(FilterType::Value::ExchangeMaxNumIcebergOrders);
    }

    SBE_NODISCARD static const char *maxNumIcebergOrdersMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
    ...
    static SBE_CONSTEXPR std::uint16_t maxNumIcebergOrdersId() SBE_NOEXCEPT
    {
        return 2;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t maxNumIcebergOrdersSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool maxNumIcebergOrdersInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t maxNumIcebergOrdersEncodingOffset() SBE_NOEXCEPT
    {
        return 0;
    }

    static SBE_CONSTEXPR std::int64_t maxNumIcebergOrdersNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t maxNumIcebergOrdersMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t maxNumIcebergOrdersMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t maxNumIcebergOrdersEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t maxNumIcebergOrders() const SBE_NOEXCEPT
    {
        std::int64_t val;
    ...
    ExchangeMaxNumIcebergOrdersFilter &maxNumIcebergOrders(const std::int64_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ExchangeMaxNumIcebergOrdersFilter &_writer)
{
    ExchangeMaxNumIcebergOrdersFilter writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExchangeMaxNumIcebergOrdersFilter", )";
    ...
    builder << ", ";
    builder << R"("maxNumIcebergOrders": )";
    builder << +writer.maxNumIcebergOrders();
