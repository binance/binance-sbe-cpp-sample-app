...
#ifndef _SPOT_SBE_MAXNUMALGOORDERSFILTER_CXX_H_
#define _SPOT_SBE_MAXNUMALGOORDERSFILTER_CXX_H_
...
public:
    ...
    MaxNumAlgoOrdersFilter() = default;
    ...
    MaxNumAlgoOrdersFilter(char *buffer, const std::uint64_t bufferLength) :
        MaxNumAlgoOrdersFilter(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MaxNumAlgoOrdersFilter(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MaxNumAlgoOrdersFilter(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    MaxNumAlgoOrdersFilter &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    MaxNumAlgoOrdersFilter &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    MaxNumAlgoOrdersFilter &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    MaxNumAlgoOrdersFilter &sbeRewind()
    {
    ...
    {
        MaxNumAlgoOrdersFilter skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    {
        return FilterType::Value::MaxNumAlgoOrders;
    }
    ...
    {
        return static_cast<std::uint8_t>(FilterType::Value::MaxNumAlgoOrders);
    }
    ...
    MaxNumAlgoOrdersFilter &maxNumAlgoOrders(const std::int64_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MaxNumAlgoOrdersFilter &_writer)
{
    MaxNumAlgoOrdersFilter writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MaxNumAlgoOrdersFilter", )";
