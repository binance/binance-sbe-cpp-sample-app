...
#ifndef _SPOT_SBE_WEBSOCKETSESSIONLOGOUTRESPONSE_CXX_H_
#define _SPOT_SBE_WEBSOCKETSESSIONLOGOUTRESPONSE_CXX_H_
...
public:
    ...
    WebSocketSessionLogoutResponse() = default;
    ...
    WebSocketSessionLogoutResponse(char *buffer, const std::uint64_t bufferLength) :
        WebSocketSessionLogoutResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    WebSocketSessionLogoutResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        WebSocketSessionLogoutResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    WebSocketSessionLogoutResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    WebSocketSessionLogoutResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    WebSocketSessionLogoutResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    WebSocketSessionLogoutResponse &sbeRewind()
    {
    ...
    WebSocketSessionLogoutResponse &authorizedSince(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    WebSocketSessionLogoutResponse &connectedSince(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    WebSocketSessionLogoutResponse &returnRateLimits(const BoolEnum::Value value) SBE_NOEXCEPT
    {
    ...
    WebSocketSessionLogoutResponse &serverTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const WebSocketSessionLogoutResponse &_writer)
{
    WebSocketSessionLogoutResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "WebSocketSessionLogoutResponse", )";
