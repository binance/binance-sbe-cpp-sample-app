...
#ifndef _SPOT_SBE_ORDERRESPONSE_CXX_H_
#define _SPOT_SBE_ORDERRESPONSE_CXX_H_
...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(163);
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(304);
    ...
    OrderResponse(char *buffer, const std::uint64_t bufferLength) :
        OrderResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    OrderResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        OrderResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t sbeBlockLength() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(163);
    }
    ...
    OrderResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    OrderResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    {
        OrderResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    OrderResponse &priceExponent(const std::int8_t value) SBE_NOEXCEPT
    {
    ...
    OrderResponse &qtyExponent(const std::int8_t value) SBE_NOEXCEPT
    {
        std::int8_t val = (value);
    ...
    OrderResponse &orderId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    OrderResponse &orderListId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderResponse &price(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderResponse &origQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderResponse &executedQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderResponse &cummulativeQuoteQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderResponse &status(const OrderStatus::Value value) SBE_NOEXCEPT
    {
    ...
    OrderResponse &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderResponse &orderType(const OrderType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderResponse &side(const OrderSide::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderResponse &stopPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderResponse &trailingDelta(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderResponse &trailingTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderResponse &icebergQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderResponse &time(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderResponse &updateTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderResponse &isWorking(const BoolEnum::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 103, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    OrderResponse &workingTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 103, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 111, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    OrderResponse &origQuoteOrderQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 111, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    OrderResponse &strategyId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    {
        std::int32_t val;
        std::memcpy(&val, m_buffer + m_offset + 127, sizeof(std::int32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    OrderResponse &strategyType(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 127, &val, sizeof(std::int32_t));
        return *this;
    }
    ...
    OrderResponse &orderCapacity(const OrderCapacity::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderResponse &workingFloor(const Floor::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderResponse &selfTradePreventionMode(const SelfTradePreventionMode::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 134, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    OrderResponse &preventedMatchId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 134, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    OrderResponse &preventedQuantity(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 150, sizeof(std::uint8_t));
        return (val);
    }
    ...
    OrderResponse &usedSor(const BoolEnum::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderResponse &pegPriceType(const PegPriceType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderResponse &pegOffsetType(const PegOffsetType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderResponse &pegOffsetValue(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderResponse &peggedPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderResponse &expiryReason(const ExpiryReason::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderResponse &putSymbol(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
    ...
    OrderResponse &putSymbol(const std::string &str)
    {
        if (str.length() > 254)
        {
    ...
    #if __cplusplus >= 201703L
    OrderResponse &putSymbol(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    OrderResponse &putClientOrderId(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    OrderResponse &putClientOrderId(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    OrderResponse &putClientOrderId(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const OrderResponse &_writer)
{
    OrderResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
