...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(151);
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(304);
    ...
    {
        return static_cast<std::uint16_t>(151);
    }
    ...
    {
        OrderResponse skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
