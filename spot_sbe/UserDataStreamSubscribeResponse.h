...
#ifndef _SPOT_SBE_USERDATASTREAMSUBSCRIBERESPONSE_CXX_H_
#define _SPOT_SBE_USERDATASTREAMSUBSCRIBERESPONSE_CXX_H_
...
public:
    ...
    UserDataStreamSubscribeResponse() = default;
    ...
    UserDataStreamSubscribeResponse(char *buffer, const std::uint64_t bufferLength) :
        UserDataStreamSubscribeResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    UserDataStreamSubscribeResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        UserDataStreamSubscribeResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    UserDataStreamSubscribeResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    UserDataStreamSubscribeResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    UserDataStreamSubscribeResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    UserDataStreamSubscribeResponse &sbeRewind()
    {
    ...
    {
        UserDataStreamSubscribeResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    UserDataStreamSubscribeResponse &subscriptionId(const std::uint16_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const UserDataStreamSubscribeResponse &_writer)
{
    UserDataStreamSubscribeResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "UserDataStreamSubscribeResponse", )";
