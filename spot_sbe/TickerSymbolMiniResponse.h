...
#ifndef _SPOT_SBE_TICKERSYMBOLMINIRESPONSE_CXX_H_
#define _SPOT_SBE_TICKERSYMBOLMINIRESPONSE_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(215);
    ...
    TickerSymbolMiniResponse() = default;

    TickerSymbolMiniResponse(
        char *buffer,
    ...
    TickerSymbolMiniResponse(char *buffer, const std::uint64_t bufferLength) :
        TickerSymbolMiniResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    TickerSymbolMiniResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        TickerSymbolMiniResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return static_cast<std::uint16_t>(215);
    }
    ...
    TickerSymbolMiniResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    TickerSymbolMiniResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    TickerSymbolMiniResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    TickerSymbolMiniResponse &sbeRewind()
    {
    ...
    {
        TickerSymbolMiniResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    TickerSymbolMiniResponse &priceExponent(const std::int8_t value) SBE_NOEXCEPT
    {
    ...
    TickerSymbolMiniResponse &qtyExponent(const std::int8_t value) SBE_NOEXCEPT
    {
        std::int8_t val = (value);
    ...
    TickerSymbolMiniResponse &openPrice(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    TickerSymbolMiniResponse &highPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolMiniResponse &lowPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolMiniResponse &lastPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolMiniResponse &volume(const std::uint64_t index, const std::uint8_t value)
    {
        if (index >= 16)
        {
    ...
    TickerSymbolMiniResponse &putVolume(std::span<const std::uint8_t, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    TickerSymbolMiniResponse &putVolume(std::span<const std::uint8_t> src)
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    TickerSymbolMiniResponse &putVolume(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    TickerSymbolMiniResponse &putVolume(const char *const src) SBE_NOEXCEPT
    #endif
    {
    ...
    TickerSymbolMiniResponse &quoteVolume(const std::uint64_t index, const std::uint8_t value)
    {
        if (index >= 16)
        {
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    TickerSymbolMiniResponse &putQuoteVolume(std::span<const std::uint8_t, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    TickerSymbolMiniResponse &putQuoteVolume(std::span<const std::uint8_t> src)
    {
        const std::size_t srcLength = src.size();
        if (srcLength > 16)
        {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    TickerSymbolMiniResponse &putQuoteVolume(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    TickerSymbolMiniResponse &putQuoteVolume(const char *const src) SBE_NOEXCEPT
    #endif
    {
    ...
    TickerSymbolMiniResponse &openTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolMiniResponse &closeTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolMiniResponse &firstId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolMiniResponse &lastId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolMiniResponse &numTrades(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolMiniResponse &putSymbol(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
    ...
    TickerSymbolMiniResponse &putSymbol(const std::string &str)
    {
        if (str.length() > 254)
        {
    ...
    #if __cplusplus >= 201703L
    TickerSymbolMiniResponse &putSymbol(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const TickerSymbolMiniResponse &_writer)
{
    TickerSymbolMiniResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "TickerSymbolMiniResponse", )";
