...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(302);
    ...
    {
        NewOrderFullResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    NewOrderFullResponse &origQuoteOrderQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderFullResponse &pegPriceType(const PegPriceType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    NewOrderFullResponse &pegOffsetType(const PegOffsetType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    NewOrderFullResponse &pegOffsetValue(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    NewOrderFullResponse &peggedPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderFullResponse &expiryReason(const ExpiryReason::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
