...
#ifndef _SPOT_SBE_LISTSTATUSEVENT_CXX_H_
#define _SPOT_SBE_LISTSTATUSEVENT_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(606);
    ...
    ListStatusEvent(char *buffer, const std::uint64_t bufferLength) :
        ListStatusEvent(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ListStatusEvent(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ListStatusEvent(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return static_cast<std::uint16_t>(606);
    }
    ...
    ListStatusEvent &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ListStatusEvent &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    {
        ListStatusEvent skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    ListStatusEvent &eventTime(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    ListStatusEvent &transactTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ListStatusEvent &orderListId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ListStatusEvent &contingencyType(const ContingencyType::Value value) SBE_NOEXCEPT
    {
    ...
    ListStatusEvent &listStatusType(const ListStatusType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ListStatusEvent &listOrderStatus(const ListOrderStatus::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    SBE_NODISCARD std::uint16_t subscriptionId() const SBE_NOEXCEPT
    {
        ...
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 27, sizeof(std::uint16_t));
        return SBE_LITTLE_ENDIAN_ENCODE_16(val);
    }

    ListStatusEvent &subscriptionId(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        std::memcpy(m_buffer + m_offset + 27, &val, sizeof(std::uint16_t));
        return *this;
    }
...
public:
    ...
    ListStatusEvent &putSymbol(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    ListStatusEvent &putSymbol(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    ListStatusEvent &putSymbol(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    ListStatusEvent &putListClientOrderId(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    ListStatusEvent &putListClientOrderId(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    ListStatusEvent &putListClientOrderId(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    ListStatusEvent &putRejectReason(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    ListStatusEvent &putRejectReason(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    ListStatusEvent &putRejectReason(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ListStatusEvent &_writer)
{
    ListStatusEvent writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ListStatusEvent", )";
