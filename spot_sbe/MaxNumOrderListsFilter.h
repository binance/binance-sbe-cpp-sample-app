...
#ifndef _SPOT_SBE_MAXNUMORDERLISTSFILTER_CXX_H_
#define _SPOT_SBE_MAXNUMORDERLISTSFILTER_CXX_H_
...
public:
    ...
    MaxNumOrderListsFilter() = default;
    ...
    MaxNumOrderListsFilter(char *buffer, const std::uint64_t bufferLength) :
        MaxNumOrderListsFilter(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MaxNumOrderListsFilter(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MaxNumOrderListsFilter(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    MaxNumOrderListsFilter &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    MaxNumOrderListsFilter &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    MaxNumOrderListsFilter &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    MaxNumOrderListsFilter &sbeRewind()
    {
    ...
    {
        MaxNumOrderListsFilter skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    {
        return FilterType::Value::MaxNumOrderLists;
    }
    ...
    {
        return static_cast<std::uint8_t>(FilterType::Value::MaxNumOrderLists);
    }
    ...
    MaxNumOrderListsFilter &maxNumOrderLists(const std::int64_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MaxNumOrderListsFilter &_writer)
{
    MaxNumOrderListsFilter writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MaxNumOrderListsFilter", )";
