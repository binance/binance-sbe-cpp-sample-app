...
#ifndef _SPOT_SBE_EVENTSTREAMTERMINATEDEVENT_CXX_H_
#define _SPOT_SBE_EVENTSTREAMTERMINATEDEVENT_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(602);
    ...
    EventStreamTerminatedEvent() = default;
    ...
    EventStreamTerminatedEvent(char *buffer, const std::uint64_t bufferLength) :
        EventStreamTerminatedEvent(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    EventStreamTerminatedEvent(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        EventStreamTerminatedEvent(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    EventStreamTerminatedEvent &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    EventStreamTerminatedEvent &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    EventStreamTerminatedEvent &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    EventStreamTerminatedEvent &sbeRewind()
    {
    ...
    {
        EventStreamTerminatedEvent skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    EventStreamTerminatedEvent &eventTime(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    EventStreamTerminatedEvent &subscriptionId(const std::uint16_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const EventStreamTerminatedEvent &_writer)
{
    EventStreamTerminatedEvent writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "EventStreamTerminatedEvent", )";
