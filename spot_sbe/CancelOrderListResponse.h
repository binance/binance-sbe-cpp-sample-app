...
#ifndef _SPOT_SBE_CANCELORDERLISTRESPONSE_CXX_H_
#define _SPOT_SBE_CANCELORDERLISTRESPONSE_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(312);
    ...
    CancelOrderListResponse() = default;
    ...
    CancelOrderListResponse(char *buffer, const std::uint64_t bufferLength) :
        CancelOrderListResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    CancelOrderListResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        CancelOrderListResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return static_cast<std::uint16_t>(312);
    }
    ...
    CancelOrderListResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    CancelOrderListResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    CancelOrderListResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    CancelOrderListResponse &sbeRewind()
    {
    ...
    {
        CancelOrderListResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    CancelOrderListResponse &orderListId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    CancelOrderListResponse &contingencyType(const ContingencyType::Value value) SBE_NOEXCEPT
    {
    ...
    CancelOrderListResponse &listStatusType(const ListStatusType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    CancelOrderListResponse &listOrderStatus(const ListOrderStatus::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    CancelOrderListResponse &transactionTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderListResponse &priceExponent(const std::int8_t value) SBE_NOEXCEPT
    {
    ...
    CancelOrderListResponse &qtyExponent(const std::int8_t value) SBE_NOEXCEPT
    {
        std::int8_t val = (value);
...
public:
    ...
    #pragma GCC diagnostic pop
            ...
            m_bufferLength = bufferLength;
            GroupSize16Encoding dimensions(buffer, *pos, bufferLength, actingVersion);
            dimensions.blockLength(static_cast<std::uint16_t>(135));
            dimensions.numInGroup(static_cast<std::uint16_t>(count));
            m_index = 0;
            m_count = count;
            m_blockLength = 135;
        ...
        {
            std::int32_t val;
            std::memcpy(&val, m_buffer + m_offset + 100, sizeof(std::int32_t));
        ...
        OrderReports &strategyType(const std::int32_t value) SBE_NOEXCEPT
        {
            ...
            std::memcpy(m_buffer + m_offset + 100, &val, sizeof(std::int32_t));
            return *this;
        }
        ...
        {
            std::int64_t val;
            std::memcpy(&val, m_buffer + m_offset + 107, sizeof(std::int64_t));
            return SBE_LITTLE_ENDIAN_ENCODE_64(val);
        }
        ...
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
            std::memcpy(m_buffer + m_offset + 107, &val, sizeof(std::int64_t));
            return *this;
        }
        ...
        OrderReports &origQuoteOrderQty(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        OrderReports &pegPriceType(const PegPriceType::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        OrderReports &pegOffsetType(const PegOffsetType::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        OrderReports &pegOffsetValue(const std::uint8_t value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        SBE_NODISCARD std::int64_t peggedPrice() const SBE_NOEXCEPT
        {
            ...
            std::int64_t val;
            std::memcpy(&val, m_buffer + m_offset + 127, sizeof(std::int64_t));
            return SBE_LITTLE_ENDIAN_ENCODE_64(val);
        }

        OrderReports &peggedPrice(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
            std::memcpy(m_buffer + m_offset + 127, &val, sizeof(std::int64_t));
            return *this;
        }
        ...
        OrderReports &putOrigClientOrderId(const char *src, const std::uint8_t length)
        {
            std::uint64_t lengthOfLengthField = 1;
            std::uint64_t lengthPosition = sbePosition();
            std::uint8_t lengthFieldValue = (length);
        ...
        OrderReports &putOrigClientOrderId(const std::string &str)
        {
            if (str.length() > 254)
            {
                throw std::runtime_error("std::string too long for length type [E109]");
        ...
        #if __cplusplus >= 201703L
        OrderReports &putOrigClientOrderId(const std::string_view str)
        {
            if (str.length() > 254)
            {
                throw std::runtime_error("std::string too long for length type [E109]");
...
public:
    ...
    CancelOrderListResponse &putListClientOrderId(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    CancelOrderListResponse &putListClientOrderId(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    CancelOrderListResponse &putListClientOrderId(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    CancelOrderListResponse &putSymbol(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    CancelOrderListResponse &putSymbol(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    CancelOrderListResponse &putSymbol(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const CancelOrderListResponse &_writer)
{
    CancelOrderListResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "CancelOrderListResponse", )";
...
#pragma GCC diagnostic ignored "-Wtype-limits"
    ...
    for (const auto &e: orderReportsItemLengths)
    {
        ...
        #else
        length += OrderReports::computeLength(std::get<0>(e), std::get<1>(e), std::get<2>(e));
        #endif
    }
