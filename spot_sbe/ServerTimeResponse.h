...
#ifndef _SPOT_SBE_SERVERTIMERESPONSE_CXX_H_
#define _SPOT_SBE_SERVERTIMERESPONSE_CXX_H_
...
public:
    ...
    ServerTimeResponse(char *buffer, const std::uint64_t bufferLength) :
        ServerTimeResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ServerTimeResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ServerTimeResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ServerTimeResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ServerTimeResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    ServerTimeResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    {
        ServerTimeResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    ServerTimeResponse &serverTime(const std::int64_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ServerTimeResponse &_writer)
{
    ServerTimeResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ServerTimeResponse", )";
