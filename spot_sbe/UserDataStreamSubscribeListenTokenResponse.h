...
#ifndef _SPOT_SBE_USERDATASTREAMSUBSCRIBELISTENTOKENRESPONSE_CXX_H_
#define _SPOT_SBE_USERDATASTREAMSUBSCRIBELISTENTOKENRESPONSE_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(505);
    ...
    UserDataStreamSubscribeListenTokenResponse() = default;
    ...
    UserDataStreamSubscribeListenTokenResponse(char *buffer, const std::uint64_t bufferLength) :
        UserDataStreamSubscribeListenTokenResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    UserDataStreamSubscribeListenTokenResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        UserDataStreamSubscribeListenTokenResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    UserDataStreamSubscribeListenTokenResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    UserDataStreamSubscribeListenTokenResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    UserDataStreamSubscribeListenTokenResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    UserDataStreamSubscribeListenTokenResponse &sbeRewind()
    {
    ...
    {
        UserDataStreamSubscribeListenTokenResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    UserDataStreamSubscribeListenTokenResponse &subscriptionId(const std::uint16_t value) SBE_NOEXCEPT
    {
    ...
    UserDataStreamSubscribeListenTokenResponse &expirationTime(const std::int64_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const UserDataStreamSubscribeListenTokenResponse &_writer)
{
    UserDataStreamSubscribeListenTokenResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "UserDataStreamSubscribeListenTokenResponse", )";
