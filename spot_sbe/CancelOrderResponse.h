...
#ifndef _SPOT_SBE_CANCELORDERRESPONSE_CXX_H_
#define _SPOT_SBE_CANCELORDERRESPONSE_CXX_H_
...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(137);
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(305);
    ...
    CancelOrderResponse(char *buffer, const std::uint64_t bufferLength) :
        CancelOrderResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    CancelOrderResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        CancelOrderResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t sbeBlockLength() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(137);
    }
    ...
    {
        return static_cast<std::uint16_t>(305);
    }
    ...
    CancelOrderResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    CancelOrderResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    CancelOrderResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    {
        CancelOrderResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    CancelOrderResponse &priceExponent(const std::int8_t value) SBE_NOEXCEPT
    {
    ...
    CancelOrderResponse &qtyExponent(const std::int8_t value) SBE_NOEXCEPT
    {
        std::int8_t val = (value);
    ...
    CancelOrderResponse &orderId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    CancelOrderResponse &orderListId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderResponse &transactTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderResponse &price(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderResponse &origQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderResponse &executedQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderResponse &cummulativeQuoteQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderResponse &status(const OrderStatus::Value value) SBE_NOEXCEPT
    {
    ...
    CancelOrderResponse &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    CancelOrderResponse &orderType(const OrderType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    CancelOrderResponse &side(const OrderSide::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    CancelOrderResponse &stopPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderResponse &trailingDelta(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderResponse &trailingTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderResponse &icebergQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderResponse &strategyId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    {
        std::int32_t val;
        std::memcpy(&val, m_buffer + m_offset + 102, sizeof(std::int32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    CancelOrderResponse &strategyType(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 102, &val, sizeof(std::int32_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 106, sizeof(std::uint8_t));
        return (val);
    }
    ...
    CancelOrderResponse &orderCapacity(const OrderCapacity::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 106, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    CancelOrderResponse &workingFloor(const Floor::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    CancelOrderResponse &selfTradePreventionMode(const SelfTradePreventionMode::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    CancelOrderResponse &preventedQuantity(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderResponse &usedSor(const BoolEnum::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    CancelOrderResponse &origQuoteOrderQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderResponse &pegPriceType(const PegPriceType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    CancelOrderResponse &pegOffsetType(const PegOffsetType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    CancelOrderResponse &pegOffsetValue(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    CancelOrderResponse &peggedPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    CancelOrderResponse &putSymbol(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
    ...
    CancelOrderResponse &putSymbol(const std::string &str)
    {
        if (str.length() > 254)
        {
    ...
    #if __cplusplus >= 201703L
    CancelOrderResponse &putSymbol(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    CancelOrderResponse &putOrigClientOrderId(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    CancelOrderResponse &putOrigClientOrderId(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    CancelOrderResponse &putOrigClientOrderId(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    CancelOrderResponse &putClientOrderId(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    CancelOrderResponse &putClientOrderId(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    CancelOrderResponse &putClientOrderId(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const CancelOrderResponse &_writer)
{
    CancelOrderResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "CancelOrderResponse", )";
