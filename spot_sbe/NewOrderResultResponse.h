...
#ifndef _SPOT_SBE_NEWORDERRESULTRESPONSE_CXX_H_
#define _SPOT_SBE_NEWORDERRESULTRESPONSE_CXX_H_
...
public:
    ...
    NewOrderResultResponse() = default;
    ...
    NewOrderResultResponse(char *buffer, const std::uint64_t bufferLength) :
        NewOrderResultResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    NewOrderResultResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        NewOrderResultResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    NewOrderResultResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    NewOrderResultResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    NewOrderResultResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    NewOrderResultResponse &sbeRewind()
    {
    ...
    {
        NewOrderResultResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    NewOrderResultResponse &priceExponent(const std::int8_t value) SBE_NOEXCEPT
    {
    ...
    NewOrderResultResponse &qtyExponent(const std::int8_t value) SBE_NOEXCEPT
    {
        std::int8_t val = (value);
    ...
    NewOrderResultResponse &orderId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    NewOrderResultResponse &orderListId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &transactTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &price(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &origQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &executedQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &cummulativeQuoteQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &status(const OrderStatus::Value value) SBE_NOEXCEPT
    {
    ...
    NewOrderResultResponse &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    NewOrderResultResponse &orderType(const OrderType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    NewOrderResultResponse &side(const OrderSide::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    NewOrderResultResponse &stopPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &trailingDelta(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &trailingTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &workingTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &icebergQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &strategyId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &strategyType(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    NewOrderResultResponse &orderCapacity(const OrderCapacity::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    NewOrderResultResponse &workingFloor(const Floor::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    NewOrderResultResponse &selfTradePreventionMode(const SelfTradePreventionMode::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    NewOrderResultResponse &tradeGroupId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &preventedQuantity(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &usedSor(const BoolEnum::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    NewOrderResultResponse &origQuoteOrderQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    SBE_NODISCARD std::uint8_t pegPriceTypeRaw() const SBE_NOEXCEPT
    {
        ...
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 142, sizeof(std::uint8_t));
        return (val);
    }
    ...
    NewOrderResultResponse &pegPriceType(const PegPriceType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 142, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    SBE_NODISCARD std::uint8_t pegOffsetTypeRaw() const SBE_NOEXCEPT
    {
        ...
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 143, sizeof(std::uint8_t));
        return (val);
    }
    ...
    NewOrderResultResponse &pegOffsetType(const PegOffsetType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 143, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    SBE_NODISCARD std::uint8_t pegOffsetValue() const SBE_NOEXCEPT
    {
        ...
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 144, sizeof(std::uint8_t));
        return (val);
    }

    NewOrderResultResponse &pegOffsetValue(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 144, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    NewOrderResultResponse &peggedPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    NewOrderResultResponse &putSymbol(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
    ...
    NewOrderResultResponse &putSymbol(const std::string &str)
    {
        if (str.length() > 254)
        {
    ...
    #if __cplusplus >= 201703L
    NewOrderResultResponse &putSymbol(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    NewOrderResultResponse &putClientOrderId(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    NewOrderResultResponse &putClientOrderId(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    NewOrderResultResponse &putClientOrderId(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const NewOrderResultResponse &_writer)
{
    NewOrderResultResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "NewOrderResultResponse", )";
