...
#ifndef _SPOT_SBE_ORDERAMENDKEEPPRIORITYRESPONSE_CXX_H_
#define _SPOT_SBE_ORDERAMENDKEEPPRIORITYRESPONSE_CXX_H_
...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(145);
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(317);
    ...
    OrderAmendKeepPriorityResponse() = default;
    ...
    OrderAmendKeepPriorityResponse(char *buffer, const std::uint64_t bufferLength) :
        OrderAmendKeepPriorityResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    OrderAmendKeepPriorityResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        OrderAmendKeepPriorityResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return static_cast<std::uint16_t>(317);
    }
    ...
    OrderAmendKeepPriorityResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    OrderAmendKeepPriorityResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    OrderAmendKeepPriorityResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    OrderAmendKeepPriorityResponse &sbeRewind()
    {
    ...
    {
        OrderAmendKeepPriorityResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    OrderAmendKeepPriorityResponse &transactTime(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    OrderAmendKeepPriorityResponse &executionId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderAmendKeepPriorityResponse &priceExponent(const std::int8_t value) SBE_NOEXCEPT
    {
    ...
    OrderAmendKeepPriorityResponse &qtyExponent(const std::int8_t value) SBE_NOEXCEPT
    {
        std::int8_t val = (value);
    ...
    OrderAmendKeepPriorityResponse &orderId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderAmendKeepPriorityResponse &orderListId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderAmendKeepPriorityResponse &price(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderAmendKeepPriorityResponse &qty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderAmendKeepPriorityResponse &executedQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderAmendKeepPriorityResponse &preventedQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    SBE_NODISCARD static const char *cumulativeQuoteQtyMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t cumulativeQuoteQtyId() SBE_NOEXCEPT
    {
        return 11;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t cumulativeQuoteQtySinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool cumulativeQuoteQtyInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t cumulativeQuoteQtyEncodingOffset() SBE_NOEXCEPT
    {
        return 66;
    }

    static SBE_CONSTEXPR std::int64_t cumulativeQuoteQtyNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t cumulativeQuoteQtyMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t cumulativeQuoteQtyMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t cumulativeQuoteQtyEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t cumulativeQuoteQty() const SBE_NOEXCEPT
    {
        std::int64_t val;
    ...
    OrderAmendKeepPriorityResponse &cumulativeQuoteQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderAmendKeepPriorityResponse &status(const OrderStatus::Value value) SBE_NOEXCEPT
    {
    ...
    OrderAmendKeepPriorityResponse &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderAmendKeepPriorityResponse &orderType(const OrderType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 77, sizeof(std::uint8_t));
        return (val);
    }
    ...
    OrderAmendKeepPriorityResponse &side(const OrderSide::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 77, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    OrderAmendKeepPriorityResponse &stopPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderAmendKeepPriorityResponse &trailingDelta(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderAmendKeepPriorityResponse &trailingTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderAmendKeepPriorityResponse &icebergQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 110, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    OrderAmendKeepPriorityResponse &workingTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 110, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 118, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    OrderAmendKeepPriorityResponse &strategyId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 118, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    {
        std::int32_t val;
        std::memcpy(&val, m_buffer + m_offset + 126, sizeof(std::int32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    OrderAmendKeepPriorityResponse &strategyType(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 126, &val, sizeof(std::int32_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 130, sizeof(std::uint8_t));
        return (val);
    }
    ...
    OrderAmendKeepPriorityResponse &orderCapacity(const OrderCapacity::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 130, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    OrderAmendKeepPriorityResponse &workingFloor(const Floor::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderAmendKeepPriorityResponse &selfTradePreventionMode(const SelfTradePreventionMode::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderAmendKeepPriorityResponse &usedSor(const BoolEnum::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    SBE_NODISCARD std::uint8_t pegPriceTypeRaw() const SBE_NOEXCEPT
    {
        ...
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 134, sizeof(std::uint8_t));
        return (val);
    }
    ...
    OrderAmendKeepPriorityResponse &pegPriceType(const PegPriceType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 134, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    OrderAmendKeepPriorityResponse &pegOffsetType(const PegOffsetType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderAmendKeepPriorityResponse &pegOffsetValue(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    SBE_NODISCARD std::int64_t peggedPrice() const SBE_NOEXCEPT
    {
        ...
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 137, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    OrderAmendKeepPriorityResponse &peggedPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 137, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    #pragma GCC diagnostic pop
        ...
        ListStatus &orderListId(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
            std::memcpy(m_buffer + m_offset + 0, &val, sizeof(std::int64_t));
            return *this;
        ...
        ListStatus &contingencyType(const ContingencyType::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        ListStatus &listOrderStatus(const ListOrderStatus::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
...
public:
        ...
        ListStatus &putListClientOrderId(const char *src, const std::uint8_t length)
        {
            std::uint64_t lengthOfLengthField = 1;
            std::uint64_t lengthPosition = sbePosition();
            std::uint8_t lengthFieldValue = (length);
        ...
        ListStatus &putListClientOrderId(const std::string &str)
        {
            if (str.length() > 254)
            {
                throw std::runtime_error("std::string too long for length type [E109]");
        ...
        #if __cplusplus >= 201703L
        ListStatus &putListClientOrderId(const std::string_view str)
        {
            if (str.length() > 254)
            {
                throw std::runtime_error("std::string too long for length type [E109]");
        ...
        ListStatus &putSymbol(const char *src, const std::uint8_t length)
        {
            std::uint64_t lengthOfLengthField = 1;
            std::uint64_t lengthPosition = sbePosition();
            std::uint8_t lengthFieldValue = (length);
        ...
        ListStatus &putSymbol(const std::string &str)
        {
            if (str.length() > 254)
            {
                throw std::runtime_error("std::string too long for length type [E109]");
        ...
        #if __cplusplus >= 201703L
        ListStatus &putSymbol(const std::string_view str)
        {
            if (str.length() > 254)
            {
                throw std::runtime_error("std::string too long for length type [E109]");
        ...
        template<typename CharT, typename Traits>
        friend std::basic_ostream<CharT, Traits> & operator << (
            std::basic_ostream<CharT, Traits> &builder, ListStatus &writer)
        {
            builder << '{';
...
public:
    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t listStatusId() SBE_NOEXCEPT
    {
        return 101;
    }

    SBE_NODISCARD inline ListStatus &listStatus()
    {
        m_listStatus.wrapForDecode(m_buffer, sbePositionPtr(), m_actingVersion, m_bufferLength);
        return m_listStatus;
    }

    ListStatus &listStatusCount(const std::uint16_t count)
    {
        m_listStatus.wrapForEncode(m_buffer, count, sbePositionPtr(), m_actingVersion, m_bufferLength);
        return m_listStatus;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t listStatusSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool listStatusInActingVersion() const SBE_NOEXCEPT
    {
        return true;
    }
    ...
    #pragma GCC diagnostic pop
            ...
            m_bufferLength = bufferLength;
            GroupSize16Encoding dimensions(buffer, *pos, bufferLength, actingVersion);
            dimensions.blockLength(static_cast<std::uint16_t>(127));
            dimensions.numInGroup(static_cast<std::uint16_t>(count));
            m_index = 0;
            m_count = count;
            m_blockLength = 127;
        ...
        RelatedOrders &orderId(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
            std::memcpy(m_buffer + m_offset + 0, &val, sizeof(std::int64_t));
            return *this;
        ...
        RelatedOrders &orderListId(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
            std::memcpy(m_buffer + m_offset + 8, &val, sizeof(std::int64_t));
            return *this;
        ...
        RelatedOrders &price(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        RelatedOrders &qty(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        RelatedOrders &executedQty(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        RelatedOrders &preventedQty(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        RelatedOrders &cumulativeQuoteQty(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        RelatedOrders &status(const OrderStatus::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        RelatedOrders &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        RelatedOrders &orderType(const OrderType::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        RelatedOrders &side(const OrderSide::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        RelatedOrders &stopPrice(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        RelatedOrders &trailingDelta(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        RelatedOrders &trailingTime(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        RelatedOrders &icebergQty(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        RelatedOrders &workingTime(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        RelatedOrders &strategyId(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        RelatedOrders &strategyType(const std::int32_t value) SBE_NOEXCEPT
        {
            std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        ...
        RelatedOrders &orderCapacity(const OrderCapacity::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        RelatedOrders &workingFloor(const Floor::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        RelatedOrders &selfTradePreventionMode(const SelfTradePreventionMode::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        RelatedOrders &usedSor(const BoolEnum::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        RelatedOrders &pegPriceType(const PegPriceType::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        RelatedOrders &pegOffsetType(const PegOffsetType::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        RelatedOrders &pegOffsetValue(const std::uint8_t value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        SBE_NODISCARD std::int64_t peggedPrice() const SBE_NOEXCEPT
        {
            ...
            std::int64_t val;
            std::memcpy(&val, m_buffer + m_offset + 119, sizeof(std::int64_t));
            return SBE_LITTLE_ENDIAN_ENCODE_64(val);
        }

        RelatedOrders &peggedPrice(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
            std::memcpy(m_buffer + m_offset + 119, &val, sizeof(std::int64_t));
            return *this;
        }
        ...
        RelatedOrders &putSymbol(const char *src, const std::uint8_t length)
        {
            std::uint64_t lengthOfLengthField = 1;
            std::uint64_t lengthPosition = sbePosition();
            std::uint8_t lengthFieldValue = (length);
        ...
        RelatedOrders &putSymbol(const std::string &str)
        {
            if (str.length() > 254)
            {
                throw std::runtime_error("std::string too long for length type [E109]");
        ...
        #if __cplusplus >= 201703L
        RelatedOrders &putSymbol(const std::string_view str)
        {
            if (str.length() > 254)
            {
                throw std::runtime_error("std::string too long for length type [E109]");
        ...
        RelatedOrders &putClientOrderId(const char *src, const std::uint8_t length)
        {
            std::uint64_t lengthOfLengthField = 1;
            std::uint64_t lengthPosition = sbePosition();
            std::uint8_t lengthFieldValue = (length);
        ...
        RelatedOrders &putClientOrderId(const std::string &str)
        {
            if (str.length() > 254)
            {
                throw std::runtime_error("std::string too long for length type [E109]");
        ...
        #if __cplusplus >= 201703L
        RelatedOrders &putClientOrderId(const std::string_view str)
        {
            if (str.length() > 254)
            {
                throw std::runtime_error("std::string too long for length type [E109]");
        ...
        template<typename CharT, typename Traits>
        friend std::basic_ostream<CharT, Traits> & operator << (
            std::basic_ostream<CharT, Traits> &builder, RelatedOrders &writer)
        {
            builder << '{';
            builder << R"("orderId": )";
            builder << +writer.orderId();
            ...
            builder << ", ";
            builder << R"("cumulativeQuoteQty": )";
            builder << +writer.cumulativeQuoteQty();
...
private:
    RelatedOrders m_relatedOrders;

public:
    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t relatedOrdersId() SBE_NOEXCEPT
    {
        return 102;
    }

    SBE_NODISCARD inline RelatedOrders &relatedOrders()
    {
        m_relatedOrders.wrapForDecode(m_buffer, sbePositionPtr(), m_actingVersion, m_bufferLength);
        return m_relatedOrders;
    }

    RelatedOrders &relatedOrdersCount(const std::uint16_t count)
    {
        m_relatedOrders.wrapForEncode(m_buffer, count, sbePositionPtr(), m_actingVersion, m_bufferLength);
        return m_relatedOrders;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t relatedOrdersSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool relatedOrdersInActingVersion() const SBE_NOEXCEPT
    {
        return true;
    }
    ...
    OrderAmendKeepPriorityResponse &putSymbol(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    OrderAmendKeepPriorityResponse &putSymbol(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    OrderAmendKeepPriorityResponse &putSymbol(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    OrderAmendKeepPriorityResponse &putOrigClientOrderId(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    OrderAmendKeepPriorityResponse &putOrigClientOrderId(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    OrderAmendKeepPriorityResponse &putOrigClientOrderId(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    OrderAmendKeepPriorityResponse &putClientOrderId(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    OrderAmendKeepPriorityResponse &putClientOrderId(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    OrderAmendKeepPriorityResponse &putClientOrderId(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const OrderAmendKeepPriorityResponse &_writer)
{
    OrderAmendKeepPriorityResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "OrderAmendKeepPriorityResponse", )";
    ...
    {
        bool atLeastOne = false;
        builder << R"("listStatus": [)";
        writer.listStatus().forEach(
    ...
    {
        bool atLeastOne = false;
        builder << R"("relatedOrders": [)";
        writer.relatedOrders().forEach(
...
void skip()
{
    auto &listStatusGroup { listStatus() };
    while (listStatusGroup.hasNext())
    {
        listStatusGroup.next().skip();
    }
    auto &relatedOrdersGroup { relatedOrders() };
    while (relatedOrdersGroup.hasNext())
    {
        relatedOrdersGroup.next().skip();
    }
    skipSymbol();
...
SBE_NODISCARD static std::size_t computeLength(
    const std::vector<std::tuple<
        const std::vector<std::tuple<
            ...
            std::size_t>> &,
        std::size_t,
        std::size_t>> &listStatusItemLengths = {},
    const std::vector<std::tuple<
        std::size_t,
        std::size_t>> &relatedOrdersItemLengths = {},
    std::size_t symbolLength = 0,
...
#pragma GCC diagnostic ignored "-Wtype-limits"
    ...
    length += ListStatus::sbeHeaderSize();
    if (listStatusItemLengths.size() > 65534LL)
    {
        throw std::runtime_error("listStatusItemLengths.size() outside of allowed range [E110]");
    }

    for (const auto &e: listStatusItemLengths)
    {
        #if __cplusplus >= 201703L
        length += std::apply(ListStatus::computeLength, e);
        #else
        length += ListStatus::computeLength(std::get<0>(e), std::get<1>(e), std::get<2>(e));
        #endif
    }

    length += RelatedOrders::sbeHeaderSize();
    if (relatedOrdersItemLengths.size() > 65534LL)
    {
        throw std::runtime_error("relatedOrdersItemLengths.size() outside of allowed range [E110]");
    }

    for (const auto &e: relatedOrdersItemLengths)
    {
        #if __cplusplus >= 201703L
        length += std::apply(RelatedOrders::computeLength, e);
        #else
        length += RelatedOrders::computeLength(std::get<0>(e), std::get<1>(e));
        #endif
    }
