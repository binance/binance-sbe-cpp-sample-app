...
#ifndef _SPOT_SBE_USERDATASTREAMUNSUBSCRIBERESPONSE_CXX_H_
#define _SPOT_SBE_USERDATASTREAMUNSUBSCRIBERESPONSE_CXX_H_
...
public:
    ...
    UserDataStreamUnsubscribeResponse() = default;
    ...
    UserDataStreamUnsubscribeResponse(char *buffer, const std::uint64_t bufferLength) :
        UserDataStreamUnsubscribeResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    UserDataStreamUnsubscribeResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        UserDataStreamUnsubscribeResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    UserDataStreamUnsubscribeResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    UserDataStreamUnsubscribeResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    UserDataStreamUnsubscribeResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    UserDataStreamUnsubscribeResponse &sbeRewind()
    {
    ...
    {
        UserDataStreamUnsubscribeResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const UserDataStreamUnsubscribeResponse &_writer)
{
    UserDataStreamUnsubscribeResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "UserDataStreamUnsubscribeResponse", )";
