...
#ifndef _SPOT_SBE_EXECUTIONREPORTEVENT_CXX_H_
#define _SPOT_SBE_EXECUTIONREPORTEVENT_CXX_H_
...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(282);
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(603);
    ...
    ExecutionReportEvent(char *buffer, const std::uint64_t bufferLength) :
        ExecutionReportEvent(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExecutionReportEvent(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExecutionReportEvent(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t sbeBlockLength() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(282);
    }
    ...
    {
        return static_cast<std::uint16_t>(603);
    }
    ...
    ExecutionReportEvent &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ExecutionReportEvent &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    ExecutionReportEvent &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    ExecutionReportEvent &sbeRewind()
    {
    ...
    {
        ExecutionReportEvent skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    ExecutionReportEvent &eventTime(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportEvent &transactTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportEvent &priceExponent(const std::int8_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportEvent &qtyExponent(const std::int8_t value) SBE_NOEXCEPT
    {
        std::int8_t val = (value);
    ...
    ExecutionReportEvent &commissionExponent(const std::int8_t value) SBE_NOEXCEPT
    {
        std::int8_t val = (value);
    ...
    SBE_NODISCARD static const char *orderCreationTimeMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
    ...
    static SBE_CONSTEXPR std::uint16_t orderCreationTimeId() SBE_NOEXCEPT
    {
        return 6;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t orderCreationTimeSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool orderCreationTimeInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t orderCreationTimeEncodingOffset() SBE_NOEXCEPT
    {
        return 19;
    }

    static SBE_CONSTEXPR std::int64_t orderCreationTimeNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t orderCreationTimeMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t orderCreationTimeMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t orderCreationTimeEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t orderCreationTime() const SBE_NOEXCEPT
    {
        std::int64_t val;
    ...
    ExecutionReportEvent &orderCreationTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportEvent &workingTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportEvent &orderId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportEvent &orderListId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportEvent &origQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportEvent &price(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    SBE_NODISCARD static const char *origQuoteOrderQtyMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t origQuoteOrderQtyId() SBE_NOEXCEPT
    {
        return 12;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t origQuoteOrderQtySinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool origQuoteOrderQtyInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t origQuoteOrderQtyEncodingOffset() SBE_NOEXCEPT
    {
        return 67;
    }

    static SBE_CONSTEXPR std::int64_t origQuoteOrderQtyNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t origQuoteOrderQtyMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t origQuoteOrderQtyMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t origQuoteOrderQtyEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t origQuoteOrderQty() const SBE_NOEXCEPT
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 67, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &origQuoteOrderQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 67, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 75, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &icebergQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 75, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 83, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &stopPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 83, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    ExecutionReportEvent &orderType(const OrderType::Value value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportEvent &side(const OrderSide::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 93, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportEvent &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 93, &val, sizeof(std::uint8_t));
        return *this;
    }

    SBE_NODISCARD static const char *executionTypeMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t executionTypeId() SBE_NOEXCEPT
    {
        return 18;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t executionTypeSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool executionTypeInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t executionTypeEncodingOffset() SBE_NOEXCEPT
    {
        return 94;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t executionTypeEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD std::uint8_t executionTypeRaw() const SBE_NOEXCEPT
    {
        std::uint8_t val;
    ...
    SBE_NODISCARD ExecutionType::Value executionType() const
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 94, sizeof(std::uint8_t));
        return ExecutionType::get((val));
    }

    ExecutionReportEvent &executionType(const ExecutionType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    SBE_NODISCARD static const char *orderStatusMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t orderStatusId() SBE_NOEXCEPT
    {
        return 19;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t orderStatusSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool orderStatusInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t orderStatusEncodingOffset() SBE_NOEXCEPT
    {
        return 95;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t orderStatusEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD std::uint8_t orderStatusRaw() const SBE_NOEXCEPT
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 95, sizeof(std::uint8_t));
        return (val);
    }

    SBE_NODISCARD OrderStatus::Value orderStatus() const
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 95, sizeof(std::uint8_t));
    ...
    ExecutionReportEvent &orderStatus(const OrderStatus::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 95, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    ExecutionReportEvent &tradeId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    static SBE_CONSTEXPR std::int64_t executionIdNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t executionIdMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t executionIdMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }
    ...
    SBE_NODISCARD std::int64_t executionId() const SBE_NOEXCEPT
    {
        std::int64_t val;
    ...
    ExecutionReportEvent &executionId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportEvent &executedQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 120, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &cummulativeQuoteQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 120, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    ExecutionReportEvent &lastQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportEvent &lastPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportEvent &quoteQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportEvent &commission(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    SBE_NODISCARD static const char *isWorkingMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t isWorkingId() SBE_NOEXCEPT
    {
        return 28;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t isWorkingSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool isWorkingInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t isWorkingEncodingOffset() SBE_NOEXCEPT
    {
        return 160;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t isWorkingEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD std::uint8_t isWorkingRaw() const SBE_NOEXCEPT
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 160, sizeof(std::uint8_t));
        return (val);
    }

    SBE_NODISCARD BoolEnum::Value isWorking() const
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 160, sizeof(std::uint8_t));
    ...
    ExecutionReportEvent &isWorking(const BoolEnum::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 160, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 161, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportEvent &isMaker(const BoolEnum::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 161, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 162, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportEvent &isBestMatch(const BoolEnum::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 162, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 163, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportEvent &matchType(const MatchType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 163, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 164, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportEvent &selfTradePreventionMode(const SelfTradePreventionMode::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 164, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 165, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportEvent &orderCapacity(const OrderCapacity::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 165, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 166, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportEvent &workingFloor(const Floor::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 166, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 167, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportEvent &usedSor(const BoolEnum::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 167, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 168, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &allocId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 168, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    static SBE_CONSTEXPR std::uint64_t trailingDeltaNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_UINT64;
    }

    static SBE_CONSTEXPR std::uint64_t trailingDeltaMinValue() SBE_NOEXCEPT
    {
        return UINT64_C(0x0);
    }

    static SBE_CONSTEXPR std::uint64_t trailingDeltaMaxValue() SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD std::uint64_t trailingDelta() const SBE_NOEXCEPT
    {
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 176, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &trailingDelta(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 176, &val, sizeof(std::uint64_t));
        return *this;
    }
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 184, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &trailingTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 184, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 192, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &tradeGroupId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 192, &val, sizeof(std::int64_t));
        return *this;
    }

    SBE_NODISCARD static const char *preventedQtyMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t preventedQtyId() SBE_NOEXCEPT
    {
        return 40;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t preventedQtySinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool preventedQtyInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t preventedQtyEncodingOffset() SBE_NOEXCEPT
    {
        return 200;
    }

    static SBE_CONSTEXPR std::int64_t preventedQtyNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t preventedQtyMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t preventedQtyMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t preventedQtyEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t preventedQty() const SBE_NOEXCEPT
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 200, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &preventedQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 200, &val, sizeof(std::int64_t));
        return *this;
    }

    SBE_NODISCARD static const char *lastPreventedQtyMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t lastPreventedQtyId() SBE_NOEXCEPT
    {
        return 41;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t lastPreventedQtySinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool lastPreventedQtyInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t lastPreventedQtyEncodingOffset() SBE_NOEXCEPT
    {
        return 208;
    }

    static SBE_CONSTEXPR std::int64_t lastPreventedQtyNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t lastPreventedQtyMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t lastPreventedQtyMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t lastPreventedQtyEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t lastPreventedQty() const SBE_NOEXCEPT
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 208, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &lastPreventedQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 208, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 216, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &preventedMatchId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 216, &val, sizeof(std::int64_t));
        return *this;
    }

    SBE_NODISCARD static const char *preventedExecutionQtyMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t preventedExecutionQtyId() SBE_NOEXCEPT
    {
        return 43;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t preventedExecutionQtySinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool preventedExecutionQtyInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t preventedExecutionQtyEncodingOffset() SBE_NOEXCEPT
    {
        return 224;
    }

    static SBE_CONSTEXPR std::int64_t preventedExecutionQtyNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t preventedExecutionQtyMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t preventedExecutionQtyMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t preventedExecutionQtyEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t preventedExecutionQty() const SBE_NOEXCEPT
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 224, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &preventedExecutionQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 224, &val, sizeof(std::int64_t));
        return *this;
    }

    SBE_NODISCARD static const char *preventedExecutionPriceMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t preventedExecutionPriceId() SBE_NOEXCEPT
    {
        return 44;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t preventedExecutionPriceSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool preventedExecutionPriceInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t preventedExecutionPriceEncodingOffset() SBE_NOEXCEPT
    {
        return 232;
    }

    static SBE_CONSTEXPR std::int64_t preventedExecutionPriceNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t preventedExecutionPriceMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t preventedExecutionPriceMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t preventedExecutionPriceEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t preventedExecutionPrice() const SBE_NOEXCEPT
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 232, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &preventedExecutionPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 232, &val, sizeof(std::int64_t));
        return *this;
    }

    SBE_NODISCARD static const char *preventedExecutionQuoteQtyMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t preventedExecutionQuoteQtyId() SBE_NOEXCEPT
    {
        return 45;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t preventedExecutionQuoteQtySinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool preventedExecutionQuoteQtyInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t preventedExecutionQuoteQtyEncodingOffset() SBE_NOEXCEPT
    {
        return 240;
    }

    static SBE_CONSTEXPR std::int64_t preventedExecutionQuoteQtyNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t preventedExecutionQuoteQtyMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t preventedExecutionQuoteQtyMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t preventedExecutionQuoteQtyEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t preventedExecutionQuoteQty() const SBE_NOEXCEPT
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 240, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &preventedExecutionQuoteQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 240, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    {
        std::int32_t val;
        std::memcpy(&val, m_buffer + m_offset + 248, sizeof(std::int32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    ExecutionReportEvent &strategyType(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 248, &val, sizeof(std::int32_t));
        return *this;
    }
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 252, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &strategyId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 252, &val, sizeof(std::int64_t));
        return *this;
    }

    SBE_NODISCARD static const char *counterOrderIdMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t counterOrderIdId() SBE_NOEXCEPT
    {
        return 48;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t counterOrderIdSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool counterOrderIdInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t counterOrderIdEncodingOffset() SBE_NOEXCEPT
    {
        return 260;
    }

    static SBE_CONSTEXPR std::int64_t counterOrderIdNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t counterOrderIdMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t counterOrderIdMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t counterOrderIdEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t counterOrderId() const SBE_NOEXCEPT
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 260, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &counterOrderId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 260, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    SBE_NODISCARD std::uint16_t subscriptionId() const SBE_NOEXCEPT
    {
        ...
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 268, sizeof(std::uint16_t));
        return SBE_LITTLE_ENDIAN_ENCODE_16(val);
    }

    ExecutionReportEvent &subscriptionId(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        std::memcpy(m_buffer + m_offset + 268, &val, sizeof(std::uint16_t));
        return *this;
    }
    ...
    SBE_NODISCARD std::uint8_t pegPriceTypeRaw() const SBE_NOEXCEPT
    {
        ...
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 270, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportEvent &pegPriceType(const PegPriceType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 270, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    SBE_NODISCARD std::uint8_t pegOffsetTypeRaw() const SBE_NOEXCEPT
    {
        ...
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 271, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportEvent &pegOffsetType(const PegOffsetType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 271, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    SBE_NODISCARD std::uint8_t pegOffsetValue() const SBE_NOEXCEPT
    {
        ...
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 272, sizeof(std::uint8_t));
        return (val);
    }

    ExecutionReportEvent &pegOffsetValue(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 272, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    SBE_NODISCARD std::int64_t peggedPrice() const SBE_NOEXCEPT
    {
        ...
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 273, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportEvent &peggedPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 273, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    SBE_NODISCARD std::uint8_t expiryReasonRaw() const SBE_NOEXCEPT
    {
        ...
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 281, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportEvent &expiryReason(const ExpiryReason::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 281, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    ExecutionReportEvent &putSymbol(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
    ...
    ExecutionReportEvent &putSymbol(const std::string &str)
    {
        if (str.length() > 254)
        {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportEvent &putSymbol(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    ExecutionReportEvent &putClientOrderId(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    ExecutionReportEvent &putClientOrderId(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    ExecutionReportEvent &putClientOrderId(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    SBE_NODISCARD static const char *origClientOrderIdMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static const char *origClientOrderIdCharacterEncoding() SBE_NOEXCEPT
    {
        return "UTF-8";
    }

    static SBE_CONSTEXPR std::uint64_t origClientOrderIdSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    bool origClientOrderIdInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    static SBE_CONSTEXPR std::uint16_t origClientOrderIdId() SBE_NOEXCEPT
    {
        return 202;
    }

    static SBE_CONSTEXPR std::uint64_t origClientOrderIdHeaderLength() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD std::uint8_t origClientOrderIdLength() const
    {
        std::uint8_t length;
        std::memcpy(&length, m_buffer + sbePosition(), sizeof(std::uint8_t));
        return (length);
    ...
    std::uint64_t skipOrigClientOrderId()
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue;
    ...
    SBE_NODISCARD const char *origClientOrderId()
    {
        std::uint8_t lengthFieldValue;
        std::memcpy(&lengthFieldValue, m_buffer + sbePosition(), sizeof(std::uint8_t));
        const char *fieldPtr = m_buffer + sbePosition() + 1;
    ...
    std::uint64_t getOrigClientOrderId(char *dst, const std::uint64_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    ExecutionReportEvent &putOrigClientOrderId(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    std::string getOrigClientOrderIdAsString()
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    std::string getOrigClientOrderIdAsJsonEscapedString()
    {
        std::ostringstream oss;
        std::string s = getOrigClientOrderIdAsString();
    ...
    #if __cplusplus >= 201703L
    std::string_view getOrigClientOrderIdAsStringView()
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    ExecutionReportEvent &putOrigClientOrderId(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
        }
        return putOrigClientOrderId(str.data(), static_cast<std::uint8_t>(str.length()));
    }

    #if __cplusplus >= 201703L
    ExecutionReportEvent &putOrigClientOrderId(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    ExecutionReportEvent &putCommissionAsset(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    ExecutionReportEvent &putCommissionAsset(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    ExecutionReportEvent &putCommissionAsset(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    static const char *rejectReasonCharacterEncoding() SBE_NOEXCEPT
    {
        return "UTF-8";
    }

    static SBE_CONSTEXPR std::uint64_t rejectReasonSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    bool rejectReasonInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }
    ...
    static SBE_CONSTEXPR std::uint64_t rejectReasonHeaderLength() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD std::uint8_t rejectReasonLength() const
    {
        std::uint8_t length;
        std::memcpy(&length, m_buffer + sbePosition(), sizeof(std::uint8_t));
        return (length);
    ...
    SBE_NODISCARD const char *rejectReason()
    {
        std::uint8_t lengthFieldValue;
        std::memcpy(&lengthFieldValue, m_buffer + sbePosition(), sizeof(std::uint8_t));
        const char *fieldPtr = m_buffer + sbePosition() + 1;
    ...
    std::uint64_t getRejectReason(char *dst, const std::uint64_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    ExecutionReportEvent &putRejectReason(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    std::string getRejectReasonAsString()
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    std::string getRejectReasonAsJsonEscapedString()
    {
        std::ostringstream oss;
        std::string s = getRejectReasonAsString();
    ...
    #if __cplusplus >= 201703L
    std::string_view getRejectReasonAsStringView()
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    ExecutionReportEvent &putRejectReason(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
        }
        return putRejectReason(str.data(), static_cast<std::uint8_t>(str.length()));
    }

    #if __cplusplus >= 201703L
    ExecutionReportEvent &putRejectReason(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    SBE_NODISCARD static const char *counterSymbolMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static const char *counterSymbolCharacterEncoding() SBE_NOEXCEPT
    {
        return "UTF-8";
    }

    static SBE_CONSTEXPR std::uint64_t counterSymbolSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    bool counterSymbolInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    static SBE_CONSTEXPR std::uint16_t counterSymbolId() SBE_NOEXCEPT
    {
        return 205;
    }

    static SBE_CONSTEXPR std::uint64_t counterSymbolHeaderLength() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD std::uint8_t counterSymbolLength() const
    {
        std::uint8_t length;
        std::memcpy(&length, m_buffer + sbePosition(), sizeof(std::uint8_t));
        return (length);
    ...
    std::uint64_t skipCounterSymbol()
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue;
    ...
    SBE_NODISCARD const char *counterSymbol()
    {
        std::uint8_t lengthFieldValue;
        std::memcpy(&lengthFieldValue, m_buffer + sbePosition(), sizeof(std::uint8_t));
        const char *fieldPtr = m_buffer + sbePosition() + 1;
    ...
    std::uint64_t getCounterSymbol(char *dst, const std::uint64_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    ExecutionReportEvent &putCounterSymbol(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        std::uint8_t lengthFieldValue = (length);
    ...
    std::string getCounterSymbolAsString()
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    std::string getCounterSymbolAsJsonEscapedString()
    {
        std::ostringstream oss;
        std::string s = getCounterSymbolAsString();
    ...
    #if __cplusplus >= 201703L
    std::string_view getCounterSymbolAsStringView()
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    ExecutionReportEvent &putCounterSymbol(const std::string &str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
        }
        return putCounterSymbol(str.data(), static_cast<std::uint8_t>(str.length()));
    }

    #if __cplusplus >= 201703L
    ExecutionReportEvent &putCounterSymbol(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ExecutionReportEvent &_writer)
{
    ExecutionReportEvent writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExecutionReportEvent", )";
    ...
    builder << ", ";
    builder << R"("orderCreationTime": )";
    builder << +writer.orderCreationTime();
    ...
    builder << ", ";
    builder << R"("origQuoteOrderQty": )";
    builder << +writer.origQuoteOrderQty();
    ...
    builder << ", ";
    builder << R"("executionType": )";
    builder << '"' << writer.executionType() << '"';

    builder << ", ";
    builder << R"("orderStatus": )";
    builder << '"' << writer.orderStatus() << '"';
    ...
    builder << ", ";
    builder << R"("preventedQty": )";
    builder << +writer.preventedQty();

    builder << ", ";
    builder << R"("lastPreventedQty": )";
    builder << +writer.lastPreventedQty();
    ...
    builder << ", ";
    builder << R"("preventedExecutionQty": )";
    builder << +writer.preventedExecutionQty();

    builder << ", ";
    builder << R"("preventedExecutionPrice": )";
    builder << +writer.preventedExecutionPrice();

    builder << ", ";
    builder << R"("preventedExecutionQuoteQty": )";
    builder << +writer.preventedExecutionQuoteQty();
    ...
    builder << ", ";
    builder << R"("counterOrderId": )";
    builder << +writer.counterOrderId();
    ...
    builder << ", ";
    builder << R"("origClientOrderId": )";
    builder << '"' <<
        writer.getOrigClientOrderIdAsJsonEscapedString().c_str() << '"';
    ...
    builder << '"' <<
        writer.getRejectReasonAsJsonEscapedString().c_str() << '"';

    builder << ", ";
    builder << R"("counterSymbol": )";
    builder << '"' <<
        writer.getCounterSymbolAsJsonEscapedString().c_str() << '"';
...
SBE_NODISCARD static std::size_t computeLength(
    ...
    std::size_t origClientOrderIdLength = 0,
    std::size_t commissionAssetLength = 0,
    std::size_t rejectReasonLength = 0,
    std::size_t counterSymbolLength = 0)
{
...
#pragma GCC diagnostic ignored "-Wtype-limits"
    ...
    length += origClientOrderIdHeaderLength();
    if (origClientOrderIdLength > 254LL)
    {
        throw std::runtime_error("origClientOrderIdLength too long for length type [E109]");
    }
    length += origClientOrderIdLength;
    ...
    length += rejectReasonHeaderLength();
    if (rejectReasonLength > 254LL)
    {
        throw std::runtime_error("rejectReasonLength too long for length type [E109]");
    }
    length += rejectReasonLength;

    length += counterSymbolHeaderLength();
    if (counterSymbolLength > 254LL)
    {
        throw std::runtime_error("counterSymbolLength too long for length type [E109]");
    }
    length += counterSymbolLength;
