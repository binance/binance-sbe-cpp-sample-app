...
#ifndef _SPOT_SBE_USERDATASTREAMSTOPRESPONSE_CXX_H_
#define _SPOT_SBE_USERDATASTREAMSTOPRESPONSE_CXX_H_
...
public:
    ...
    UserDataStreamStopResponse() = default;
    ...
    UserDataStreamStopResponse(char *buffer, const std::uint64_t bufferLength) :
        UserDataStreamStopResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    UserDataStreamStopResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        UserDataStreamStopResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    UserDataStreamStopResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    UserDataStreamStopResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    UserDataStreamStopResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    UserDataStreamStopResponse &sbeRewind()
    {
    ...
    {
        UserDataStreamStopResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const UserDataStreamStopResponse &_writer)
{
    UserDataStreamStopResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "UserDataStreamStopResponse", )";
