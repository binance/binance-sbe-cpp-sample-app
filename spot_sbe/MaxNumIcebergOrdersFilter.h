...
#ifndef _SPOT_SBE_MAXNUMICEBERGORDERSFILTER_CXX_H_
#define _SPOT_SBE_MAXNUMICEBERGORDERSFILTER_CXX_H_
...
public:
    ...
    MaxNumIcebergOrdersFilter() = default;
    ...
    MaxNumIcebergOrdersFilter(char *buffer, const std::uint64_t bufferLength) :
        MaxNumIcebergOrdersFilter(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MaxNumIcebergOrdersFilter(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MaxNumIcebergOrdersFilter(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    MaxNumIcebergOrdersFilter &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    MaxNumIcebergOrdersFilter &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    MaxNumIcebergOrdersFilter &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    MaxNumIcebergOrdersFilter &sbeRewind()
    {
    ...
    {
        MaxNumIcebergOrdersFilter skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    {
        return FilterType::Value::MaxNumIcebergOrders;
    }
    ...
    {
        return static_cast<std::uint8_t>(FilterType::Value::MaxNumIcebergOrders);
    }
    ...
    MaxNumIcebergOrdersFilter &maxNumIcebergOrders(const std::int64_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MaxNumIcebergOrdersFilter &_writer)
{
    MaxNumIcebergOrdersFilter writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MaxNumIcebergOrdersFilter", )";
