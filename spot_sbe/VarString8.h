...
#ifndef _SPOT_SBE_VARSTRING8_CXX_H_
#define _SPOT_SBE_VARSTRING8_CXX_H_
...
public:
    ...
    VarString8(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        VarString8(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    VarString8(
        char *buffer,
        const std::uint64_t bufferLength) :
        VarString8(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }
    ...
    VarString8 &length(const std::uint8_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, VarString8 &writer)
{
    builder << '{';
    builder << R"("length": )";
