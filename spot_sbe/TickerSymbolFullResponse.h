...
#ifndef _SPOT_SBE_TICKERSYMBOLFULLRESPONSE_CXX_H_
#define _SPOT_SBE_TICKERSYMBOLFULLRESPONSE_CXX_H_
...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(126);
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(213);
    ...
    TickerSymbolFullResponse() = default;

    TickerSymbolFullResponse(
        char *buffer,
    ...
    TickerSymbolFullResponse(char *buffer, const std::uint64_t bufferLength) :
        TickerSymbolFullResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    TickerSymbolFullResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        TickerSymbolFullResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    TickerSymbolFullResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    TickerSymbolFullResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    TickerSymbolFullResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    TickerSymbolFullResponse &sbeRewind()
    {
    ...
    {
        TickerSymbolFullResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    TickerSymbolFullResponse &priceExponent(const std::int8_t value) SBE_NOEXCEPT
    {
    ...
    TickerSymbolFullResponse &qtyExponent(const std::int8_t value) SBE_NOEXCEPT
    {
        std::int8_t val = (value);
    ...
    TickerSymbolFullResponse &priceChange(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    TickerSymbolFullResponse &priceChangePercent(const float value) SBE_NOEXCEPT
    {
        union sbe_float_as_uint_u val;
        val.fp_value = value;
        val.uint_value = SBE_LITTLE_ENDIAN_ENCODE_32(val.uint_value);
    ...
    TickerSymbolFullResponse &weightedAvgPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolFullResponse &openPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolFullResponse &highPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolFullResponse &lowPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 46, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    TickerSymbolFullResponse &lastPrice(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 46, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    SBE_NODISCARD std::uint8_t volume(const std::uint64_t index) const
    {
        ...
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 54 + (index * 1), sizeof(std::uint8_t));
        return (val);
    }

    TickerSymbolFullResponse &volume(const std::uint64_t index, const std::uint8_t value)
    {
        if (index >= 16)
        {
        ...
        std::memcpy(m_buffer + m_offset + 54 + (index * 1), &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    std::uint64_t getVolume(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 54, sizeof(std::uint8_t) * static_cast<std::size_t>(length));
        return length;
    }
    ...
    TickerSymbolFullResponse &putVolume(std::span<const std::uint8_t, N> src) SBE_NOEXCEPT
    {
        static_assert(N <= 16, "array too large for putVolume");

        std::memcpy(m_buffer + m_offset + 54, src.data(), sizeof(std::uint8_t) * N);
    ...
    #ifdef SBE_USE_SPAN
    TickerSymbolFullResponse &putVolume(std::span<const std::uint8_t> src)
    {
        ...
        std::memcpy(m_buffer + m_offset + 54, src.data(), sizeof(std::uint8_t) * srcLength);
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    TickerSymbolFullResponse &putVolume(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    TickerSymbolFullResponse &putVolume(const char *const src) SBE_NOEXCEPT
    #endif
    {
        std::memcpy(m_buffer + m_offset + 54, src, sizeof(std::uint8_t) * 16);
        return *this;
    }
    ...
    SBE_NODISCARD std::uint8_t quoteVolume(const std::uint64_t index) const
    {
        ...
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 70 + (index * 1), sizeof(std::uint8_t));
        return (val);
    }

    TickerSymbolFullResponse &quoteVolume(const std::uint64_t index, const std::uint8_t value)
    {
        if (index >= 16)
        {
        ...
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 70 + (index * 1), &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    std::uint64_t getQuoteVolume(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 70, sizeof(std::uint8_t) * static_cast<std::size_t>(length));
        return length;
    }
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    TickerSymbolFullResponse &putQuoteVolume(std::span<const std::uint8_t, N> src) SBE_NOEXCEPT
    {
        static_assert(N <= 16, "array too large for putQuoteVolume");

        std::memcpy(m_buffer + m_offset + 70, src.data(), sizeof(std::uint8_t) * N);
        for (std::size_t start = N; start < 16; ++start)
        {
    ...
    #ifdef SBE_USE_SPAN
    TickerSymbolFullResponse &putQuoteVolume(std::span<const std::uint8_t> src)
    {
        const std::size_t srcLength = src.size();
        if (srcLength > 16)
        {
        ...
        std::memcpy(m_buffer + m_offset + 70, src.data(), sizeof(std::uint8_t) * srcLength);
        for (std::size_t start = srcLength; start < 16; ++start)
        {
            m_buffer[m_offset + 70 + start] = 0;
        }
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    TickerSymbolFullResponse &putQuoteVolume(T&& src)  SBE_NOEXCEPT requires
        (std::is_pointer_v<std::remove_reference_t<T>> &&
         !std::is_array_v<std::remove_reference_t<T>>)
    #else
    TickerSymbolFullResponse &putQuoteVolume(const char *const src) SBE_NOEXCEPT
    #endif
    {
        std::memcpy(m_buffer + m_offset + 70, src, sizeof(std::uint8_t) * 16);
        return *this;
    }
    ...
    TickerSymbolFullResponse &openTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolFullResponse &closeTime(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolFullResponse &firstId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolFullResponse &lastId(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolFullResponse &numTrades(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    TickerSymbolFullResponse &putSymbol(const char *src, const std::uint8_t length)
    {
        std::uint64_t lengthOfLengthField = 1;
        std::uint64_t lengthPosition = sbePosition();
    ...
    TickerSymbolFullResponse &putSymbol(const std::string &str)
    {
        if (str.length() > 254)
        {
    ...
    #if __cplusplus >= 201703L
    TickerSymbolFullResponse &putSymbol(const std::string_view str)
    {
        if (str.length() > 254)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const TickerSymbolFullResponse &_writer)
{
    TickerSymbolFullResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "TickerSymbolFullResponse", )";
