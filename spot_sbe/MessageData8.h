...
#ifndef _SPOT_SBE_MESSAGEDATA8_CXX_H_
#define _SPOT_SBE_MESSAGEDATA8_CXX_H_
...
public:
    ...
    MessageData8(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        MessageData8(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    MessageData8(
        char *buffer,
        const std::uint64_t bufferLength) :
        MessageData8(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }
    ...
    MessageData8 &length(const std::uint8_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MessageData8 &writer)
{
    builder << '{';
    builder << R"("length": )";
