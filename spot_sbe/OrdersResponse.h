...
#ifndef _SPOT_SBE_ORDERSRESPONSE_CXX_H_
#define _SPOT_SBE_ORDERSRESPONSE_CXX_H_
...
public:
    ...
    OrdersResponse(char *buffer, const std::uint64_t bufferLength) :
        OrdersResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    OrdersResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        OrdersResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return static_cast<std::uint16_t>(308);
    }
    ...
    OrdersResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    OrdersResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    #pragma GCC diagnostic pop
            ...
            m_bufferLength = bufferLength;
            GroupSizeEncoding dimensions(buffer, *pos, bufferLength, actingVersion);
            dimensions.blockLength(static_cast<std::uint16_t>(163));
        ...
        Orders &priceExponent(const std::int8_t value) SBE_NOEXCEPT
        {
        ...
        Orders &qtyExponent(const std::int8_t value) SBE_NOEXCEPT
        {
            std::int8_t val = (value);
        ...
        Orders &orderListId(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &price(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &origQty(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &executedQty(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &cummulativeQuoteQty(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &status(const OrderStatus::Value value) SBE_NOEXCEPT
        {
        ...
        Orders &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        Orders &orderType(const OrderType::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        Orders &side(const OrderSide::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        Orders &stopPrice(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &trailingDelta(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &trailingTime(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &icebergQty(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &time(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &updateTime(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &isWorking(const BoolEnum::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        Orders &workingTime(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &origQuoteOrderQty(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &strategyId(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &strategyType(const std::int32_t value) SBE_NOEXCEPT
        {
        ...
        Orders &orderCapacity(const OrderCapacity::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        Orders &workingFloor(const Floor::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        Orders &selfTradePreventionMode(const SelfTradePreventionMode::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        Orders &preventedMatchId(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &preventedQuantity(const std::int64_t value) SBE_NOEXCEPT
        {
            std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        Orders &usedSor(const BoolEnum::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        Orders &expiryReason(const ExpiryReason::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
...
public:
    ...
    Orders &ordersCount(const std::uint32_t count)
    {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const OrdersResponse &_writer)
{
    OrdersResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
...
#pragma GCC diagnostic ignored "-Wtype-limits"
    ...
    if (ordersItemLengths.size() > 2147483647LL)
    {
