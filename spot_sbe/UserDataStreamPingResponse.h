...
#ifndef _SPOT_SBE_USERDATASTREAMPINGRESPONSE_CXX_H_
#define _SPOT_SBE_USERDATASTREAMPINGRESPONSE_CXX_H_
...
public:
    ...
    UserDataStreamPingResponse() = default;
    ...
    UserDataStreamPingResponse(char *buffer, const std::uint64_t bufferLength) :
        UserDataStreamPingResponse(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    UserDataStreamPingResponse(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        UserDataStreamPingResponse(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    UserDataStreamPingResponse &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    UserDataStreamPingResponse &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    UserDataStreamPingResponse &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    UserDataStreamPingResponse &sbeRewind()
    {
    ...
    {
        UserDataStreamPingResponse skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const UserDataStreamPingResponse &_writer)
{
    UserDataStreamPingResponse writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "UserDataStreamPingResponse", )";
